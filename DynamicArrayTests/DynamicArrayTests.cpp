...
namespace DynamicArrayTests
{
	...
	public:
		...
		{
			//Arrange
			const unsigned int CAPACITE_DEPART = 5;
		...
		// Test perso
		//////
		TEST_METHOD(test_constructeur_avec_valeur)
		{
			//Arrange
			const unsigned int CAPACITE_TEST = 50;
			DynamicArray tableau(50);

			//Action
			unsigned int capacite = tableau.getCapacite();

			//Assert
			Assert::AreEqual(CAPACITE_TEST, capacite);
		}
		...
		{
			//Arrange
			const unsigned int TABLEAU_1_CAPACITE_DEPART = 3;
			const unsigned int TABLEAU_2_CAPACITE = 5;
		...
		{
			//Arrange
			const unsigned int TABLEAU_CAPACITE_DEPART = 3;
	...
	private:
		void AssertDynamicArraysAreEqual(DynamicArray & dynamicArray1, DynamicArray & dynamicArray2)
		{
			...
			for (unsigned int i = 0; i < dynamicArray1.getCapacite(); i++)
			{
